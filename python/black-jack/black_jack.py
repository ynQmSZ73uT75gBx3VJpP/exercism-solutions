...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    if (card_one == 'A' or card_two == 'A') and value_of_card(card_one) + value_of_card(card_two) < 10:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    return bool((card_one == 'A' and value_of_card(card_two) == 10) or (value_of_card(card_one) == 10 and card_two == 'A'))
